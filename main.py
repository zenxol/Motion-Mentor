...
def calculate_angle(a, b, c):
    ...
    Args:
        a, b, c: Coordinates of three points forming an angle.
    Returns:
        Angle in degrees.
    """
    a = np.array(a)
...
def landmark_check(landmark):
    ...
    Args:
        landmark: Coordinate of a landmark.
    Returns:
        Boolean indicating if the landmark is valid.
    """
    ...
    with mp_pose.Pose(static_image_mode=False, min_detection_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                # Check if all required joints are visible in the frame
            ...
            # Check for user input to quit or switch modes
...
def switch_mode():
    """
    Create a GUI window for switching between exercise modes.
    """
    root = ctk.CTk()
...
def show_exercise_selection():
    """
    Display the initial exercise selection GUI.
    """
    root = ctk.CTk()
...
def start_exercise(root, mode):
    ...
    Args:
        root: The Tkinter root window to be closed.
        mode: The selected exercise mode.
    """
    root.destroy()
